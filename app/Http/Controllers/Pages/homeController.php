...
class homeController extends Controller {
    ...
    public function index() {
        ...
        $properties_sale_row1 = property::where('offering_type','sale')->orWhere('offering_type2','sale')->join('photo','photo.reference_number','=','property.reference_number')->orderBy('updated_at', 'DESC')->take(3)->get();
        // dd($properties_sale_row1);
         $properties_sale_row2 = property::where('offering_type','sale')->orWhere('offering_type2','sale')->join('photo','photo.reference_number','=','property.reference_number')->orderBy('updated_at', 'DESC')->skip(3)->take(3)->get();
