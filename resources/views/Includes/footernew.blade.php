...
<script src="{{url('public/assets/js/backstretch.js')}}"></script>
...
<script type="text/javascript">
    $(document).ready(function(){
           $('.for-show-hide').click(function(){
             $('.search-inner').show();
             $('.search-tabmenu').css('width','100%');
                
           });

            $('.form-toggle2').click(function(){
            $('.search-inner').hide('slow');
             $('.search-tabmenu').css('width','20%');
...
$(window).scroll(function() {
 ...
 $(document).ready(function () {
     ...
     $('#hero-demo,#hero-demo-2').autoComplete({
        minChars: 1,
        source: function(term, suggest){
            $('img.hero-demo-2').show();
            ...
            $.ajax({
                ...
                success :function(data){
                    console.log(data);
                    $('img.hero-demo-2').hide();
                    if(data != ''){
                        choices = $.map( data, function( obj, i ) { return obj.location; } ); 
                        var suggestions = [];
...
<!-- Mirrored from storage.googleapis.com/themevessel-products/xero/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2020 09:39:16 GMT -->
</html>