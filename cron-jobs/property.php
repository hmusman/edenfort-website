<?php
  ...
  foreach($xml as $fetch){
               ...
               $referance_number = $fetch->reference_number;    
                $permit_number = $fetch->permit_number;
                $offering_type = $fetch->offering_type;
                $property_type = $fetch->property_type;
                $price_on_application = $fetch->price_on_application;
                ...
                $title_en = $fetch->title_en;
                $description_en = $fetch->description_en;
                $private_amenities = $fetch->private_amenities;
                $size = $fetch->size;
                $bedroom = $fetch->bedroom;
                $bathroom = $fetch->bathroom;
				$agentName=$fetch->agent->name;
				$agentEmail=$fetch->agent->email;
				$agentPhone=$fetch->agent->phone;
				$parking=$fetch->parking;
			    $furnished = $fetch->furnished;
			     $geopoints = $fetch->geopoints;
